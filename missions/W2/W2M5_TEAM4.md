...
이 프로젝트는 Rotten Tomatoes 웹사이트에서 현재 흥행중이지만 평가가 좋지 않은 "쥬라기 월드: 새로운 시작"의 비평가 및 일반 관객의 리뷰 데이터를 수집하고, 이를 기반으로 감성 분석 및 핵심 키워드 워드클라우드를 생성해 흥행함에도 평가가 좋지 않은 이유에 대해 분석하고 비즈니스 가치를 찾았습니다.
